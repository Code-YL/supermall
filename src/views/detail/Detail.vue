<template>
  <div id="detail">
    <detail-nav-bar @itemClick="titleClick" :current-index="currentIndex" class="de-nav-bar"></detail-nav-bar>
    <scroll class="content"
      ...
      <div>
        ...
        <detail-goods-info :detail-info="detailInfo" @infoImageLoad="infoImgLoad"></detail-goods-info>
